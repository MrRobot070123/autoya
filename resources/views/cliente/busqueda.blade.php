...
<div class="container">
    <div class="container" style="max-width: 750px; margin-top: 50px; margin-bottom: 50px;">
        <h2 class="mb-4">Nueva reserva</h2><hr>
        ...
        <form method="GET">
            <div class="card mt-4 p-4 shadow-sm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end" style="margin-bottom: 12px;">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card card-vehiculo h-100 animate-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- BOTÓN -->                               
                                    <a href="{{ url('/reservar') }}?vehiculo={{ $v->id }}&inicio={{ request('inicio') }}&fin={{ request('fin') }}"
